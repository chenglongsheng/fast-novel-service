package com.loong.novel.generator;
...
/**
 * @author rosen
 * @date 2023/5/21 10:09
 */
public class Generator {

    private static final String USERNAME = "rosen";
    ...
    private static final String BASE_PACKAGE = "com.loong.novel";

    /**
     * 数据库信息
     */
    private static final String DATABASE_IP = "47.106.196.152";
    private static final String DATABASE_PORT = "3306";
    private static final String DATABASE_NAME = "novel";
    private static final String DATABASE_USERNAME = "root";
    private static final String DATABASE_PASSWORD = "CLS4838aaoc@.";
